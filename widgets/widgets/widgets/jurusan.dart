...
import 'widgets/cakahima_inf.dart';
  ...
  Widget build(BuildContext context) {
    return Stack(
      children: [
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  Navigator.of(context).push(
                    MaterialPageRoute(
                      builder: (context) {
                        return CakahimaInfPage(); // menuju halaman cakahima_inf
                      },
                    ),
                  );
                },
        ...
        Positioned(
          top: 848.15, // Atur posisi tombol dari atas ke bawah
          left: 135, // Atur posisi tombol dari kiri ke kanan
          child: Column(
            mainAxisAlignment:
                MainAxisAlignment.start, // Menempatkan tombol di atas vertikal
            ...
            children: [
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  primary: Colors.blue, // Warna latar belakang biru
                  onPrimary: Colors.white, // Warna teks putih
                  minimumSize: Size(74, 20), // Mengubah ukuran tombol
                ),
                child: Text("Fisika"),
              ),
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  primary: Colors.blue, // Warna latar belakang biru
                  onPrimary: Colors.white, // Warna teks putih
                  minimumSize: Size(74, 22), // Mengubah ukuran tombol
                ),
                child: Text("Teknik Perkapalan"),
              ),
              ElevatedButton(
                onPressed: () {
                  // Tindakan yang diambil saat tombol "Sistem Informasi" ditekan
